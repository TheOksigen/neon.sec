...
Mən Sənin Qruplarıvı Qorumaq Üçün Azərbaycanca olan qrup idarə botuyam🇦🇿.
...
SAITAMA_IMG = "https://telegra.ph/file/7fa4cb7d8268e4e452cae.jpg"
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [[
                        InlineKeyboardButton(
                            text="☑️ N Σ O N Security qruplarınıza əlavə edin",
                            url="t.me/{}?startgroup=true".format(
                                context.bot.username))
                    ],
                     [
                         InlineKeyboardButton(
                             text="N Σ O N Userbot✅",
                             url=f"https://t.me/neonuserbot"),
                         InlineKeyboardButton(
                             text="🔔 Support Qrupu",
                             url="https://t.me/NeonSup")
                     ],
                     [
                         InlineKeyboardButton(
                             text="🤵Sahibim",
                             url="https://t.me/TheOksigen")
                     ]]))
    else:
        update.effective_message.reply_text(
            "Mən İşlək Vəziyyətdəyəm!\n<b>Bu müddətdən bəri xidmətinizdəyəm🥰:</b> <code>{}</code>"
            .format(uptime),
